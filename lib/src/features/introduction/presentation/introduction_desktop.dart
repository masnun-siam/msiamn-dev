...
class IntroductionDesktop extends ConsumerStatefulWidget {
  const IntroductionDesktop({super.key});

  @override
  ConsumerState<IntroductionDesktop> createState() =>
      _IntroductionDesktopState();
}

class _IntroductionDesktopState extends ConsumerState<IntroductionDesktop>
